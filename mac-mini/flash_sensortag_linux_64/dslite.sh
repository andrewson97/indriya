...
if [ "$#" -eq 0 ]; then
	eval "$scriptDir"/ccs_base/DebugServer/bin/DSLite $MODE -c user_files/configs/cc2650f128.ccxml -l user_files/settings/generated.ufsettings -e -f -v user_files/images/cc26xx-demo.bin,undefined 
else
